...
// start of MemberDirectoryListRenderer singleton
  ...
  function isPagerHidden()
  {
    ...
    return BonaPage.$(MemberDirectoryListRenderer.pagingBlockId) && (BonaPage.$(MemberDirectoryListRenderer.pagingBlockId).style.dysplay != 'inline');
  }
  function setDirectoryOutput(html, encodeHtml)
  {
    /*debug*/log('setDirectoryOutput');

    var outputBlock = BonaPage.$(MemberDirectoryListRenderer.outputBlockId);
