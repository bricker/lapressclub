(function()
{
    ...
    contactAdvancedSearch.dispose = function()
	  ...
	  contactAdvancedSearch.validateCriteriaSelected = function(source, args)
	  {
	      ...
	      {
	          var conditionSelector = BonaPage.$(contactAdvancedSearch.optionItems[i].csId);
	  ...
	  {	    
	    var dropDownList = BonaPage.$(controlId);
	    var dateControlContainer = BonaPage.$(linkedControlId).parentNode;
	    ...
	    var readOnlyContainer =  BonaPage.$(readOnlyContainerId);
    ...
    contactAdvancedSearch.textBoxConditionSelector = function (controlId, linkedControlContainerId)
	  {
	      var control = BonaPage.$ (controlId);
	      var linkedControlContainer = BonaPage.$ (linkedControlContainerId);
    ...
    contactAdvancedSearch.initCriteriaChangeScript = function ()
    {
        ...
        {
            var valuesContainer = BonaPage.$(optionItems[i].vsCId);
            ...
            optionItems[i].conditionSelector = BonaPage.$(optionItems[i].csId);
        }
